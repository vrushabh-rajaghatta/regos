...
/// </remarks>
public sealed class OrganizationDatabase : RegOSTestDatabase
{
    public const string Collection = "Organization database";
}
...
/// always assumed.
/// </remarks>
[CollectionDefinition(OrganizationDatabase.Collection)]
public sealed class OrganizationDatabaseCollection : ICollectionFixture<OrganizationDatabase>;
