...
/// </remarks>
public sealed class RegistrationDatabase : RegOSTestDatabase
{
    public const string Collection = "Registration database";
}
...
/// always assumed.
/// </remarks>
[CollectionDefinition(RegistrationDatabase.Collection)]
public sealed class RegistrationDatabaseCollection : ICollectionFixture<RegistrationDatabase>;
