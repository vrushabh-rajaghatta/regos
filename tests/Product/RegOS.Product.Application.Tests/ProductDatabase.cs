...
/// </remarks>
public sealed class ProductDatabase : RegOSTestDatabase
{
    public const string Collection = "Product database";
}
...
/// always assumed.
/// </remarks>
[CollectionDefinition(ProductDatabase.Collection)]
public sealed class ProductDatabaseCollection : ICollectionFixture<ProductDatabase>;
