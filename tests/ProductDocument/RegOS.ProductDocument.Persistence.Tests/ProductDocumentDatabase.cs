...
/// <c>regos_test_productdocument_persistence_…</c> rather than something
/// anonymous.
/// </remarks>
public sealed class ProductDocumentDatabase : RegOSTestDatabase
{
    public const string Collection = "ProductDocument database";
}
...
/// always assumed.
/// </remarks>
[CollectionDefinition(ProductDocumentDatabase.Collection)]
public sealed class ProductDocumentDatabaseCollection
    : ICollectionFixture<ProductDocumentDatabase>;
