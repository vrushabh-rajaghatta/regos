...
public sealed class ListContraindicationsHandler
{
    private readonly RegOSDbContext _dbContext;

    public ListContraindicationsHandler(RegOSDbContext dbContext)
    {
    ...
    /// </para>
    /// </remarks>
    public async Task<IReadOnlyList<ContraindicationSummary>> HandleAsync(
        ListContraindicationsQuery query,
        CancellationToken cancellationToken)
    {
        return await _dbContext.Contraindications
            .AsNoTracking()
            ...
            .Select(statement => new ContraindicationSummary(
                ...
                statement.Condition.Display,
                statement.Condition.System,
                statement.LabelText,
