...
/// <summary>
/// Records which planned work a letter serves.
/// </summary>
/// <remarks>
...
/// </para>
/// </remarks>
public sealed class AttachHaCorrespondenceToStepHandler
{
    private readonly IHaCorrespondenceRepository _correspondence;
    private readonly RegOSDbContext _dbContext;

    public AttachHaCorrespondenceToStepHandler(
        IHaCorrespondenceRepository correspondence,
    ...
    public async Task HandleAsync(
        AttachHaCorrespondenceToStepCommand command,
        CancellationToken cancellationToken)
    {
        var letter =
            await _correspondence.GetByIdAsync(command.HaCorrespondenceId, cancellationToken)
            ?? throw new NotFoundException("That correspondence does not exist.");
        ...
        letter.AttachToStep(command.ProcessStepId);

        await _correspondence.UpdateAsync(letter, cancellationToken);
    }
}
