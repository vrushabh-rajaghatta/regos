...
namespace RegOS.Persistence.Migrations
{
    ...
    [Migration("20260806102641_AttachSubmissionsAndRegistrationsToSteps")]
    partial class AttachSubmissionsAndRegistrationsToSteps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegOS.Product.Domain.Product.PackageMarketingStatusEntry", b =>
                {
                    ...
                    b.HasIndex("PackagedProductId", "OccurredOn");

                    b.ToTable("PackageMarketingStatusHistory", (string)null);
                });

            modelBuilder.Entity("RegOS.Product.Domain.Product.PackagedProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CurrentMarketingStatus")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("PackSizeQuantity")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");
                    ...
                    b.HasIndex("MedicinalProductId", "CurrentMarketingStatus");

                    b.ToTable("PackagedProducts", (string)null);
                });
            ...
            modelBuilder.Entity("RegOS.Product.Domain.Product.PackageMarketingStatusEntry", b =>
                {
                    b.HasOne("RegOS.Product.Domain.Product.PackagedProduct", null)
                        .WithMany("MarketingStatusHistory")
                        .HasForeignKey("PackagedProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
                    ...
                    b.OwnsOne("RegOS.Product.Domain.Product.ShelfLifeStorage", "ShelfLife", b1 =>
                        {
                            ...
                            b1.OwnsMany("RegOS.ReferenceData.Domain.Terminology.CodedConcept", "TestedAt", b2 =>
                                {
                                    b2.Property<Guid>("PackagedProductId")
                                        .HasColumnType("uuid");
                                    ...
                                    b2.ToTable("PackagedProductStabilityConditions", (string)null);
            ...
            modelBuilder.Entity("RegOS.ReferenceData.Domain.Geography.Country.Country", b =>
                {
                    ...
                    b.OwnsMany("RegOS.ReferenceData.Domain.Terminology.CodedConcept", "StabilityConditions", b1 =>
                        {
                            b1.Property<Guid>("CountryId")
                                .HasColumnType("uuid");
                            ...
                            b1.ToTable("CountryStabilityConditions", (string)null);
                    ...
                    b.Navigation("StabilityConditions");
                });
            ...
            modelBuilder.Entity("RegOS.Product.Domain.Product.PackagedProduct", b =>
                {
                    b.Navigation("MarketingStatusHistory");
                });
