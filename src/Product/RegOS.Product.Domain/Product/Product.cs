...
/// <summary>
/// A product a tenant manages within RegOS. Deliberately small: it
...
public sealed class Product : AggregateRoot<ProductId>
{
    ...
    /// <summary>
    /// The owning tenant. Set once at registration and never
    /// changed: moving a product between tenants would be a transfer, a
    ...
    /// tenant - it is the unique key the database enforces - and
    /// customers cite it in authority correspondence. Changing it is a
