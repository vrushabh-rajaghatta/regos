...
| — | ~~**EPIC-020**~~ | **Regulatory process & planning** | 🟡 **In progress — 8 of 9** (2026-08-06) — in [Now](#now) | EPIC-004 ✅ · EPIC-006 ✅ · EPIC-017 ✅ |
...
| ~~**EPIC-020**~~ | **Regulatory process & planning** — objectives, process definitions, live plans and dated steps; RIM's spine | 🟡 **In progress — 8 of 9** — in [Now](#now) | *"Deliberately last" meant its dependencies came first; EPIC-004, 006 and 017 have all shipped, so last now means next* |
