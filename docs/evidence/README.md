...
| **EPIC-007a rendering** | **E16**, **E17** | E16 shaped it before a line was written — two renderers, not one with a flag. **E17 arrived from the renderer itself**: the DTD refused a section the blueprint happily seeds, which no amount of reading the section list would have surfaced |
